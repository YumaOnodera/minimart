    ...
    <div class="row mb-5 item" data-goodsid="{{ $goods->goods_id }}">
        ...
        <div class="col-12 col-sm-7">
            ...
            <div class="introducer d-flex align-items-center mb-5">
                <div class="mr-2">
                    <a href="#"><img src="{{ $goods->avatar_img_src }}" alt="{{ $goods->user_name }}" height="32"></a>
                </div>
                <div>
    ...
    <div class="container w-50">
        <div class="row">
            <div class="row mr-auto align-items-center item" data-goodsid="{{ $goods->goods_id }}">
                <div class="like_count">
                    <div class="btn-like d-flex align-items-center">
                        ...
                        @endif
                        <span class="like-count text-secondary ml-2 h5">{{ $goods->like_count }}</span>
                    </div>
                </div>
            ...
            <div class="row mx-auto">
                ...
                <button class="btn ml-4" onclick="location.href='/goods/{{ $goods->goods_id }}/edit'"><i class="fas fa-edit text-secondary h4"></i></button>
